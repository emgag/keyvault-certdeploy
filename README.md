...
The files generated by this command follow the same convention as common Let's Encrypt utitilities like [certbot](https://github.com/certbot/certbot) or [dehydrated](https://github.com/lukas2511/dehydrated):
